...
export default function Octree( parameters ) {
    ...
    this.objectsUpdated = [];
    this.objectsDataMap = new WeakMap();
...
Octree.prototype = {
    ...
    addObjectData: function ( object, part ) {
        ...
        this.objectsDataMap.set(object, objectData);
    ...
    remove: function ( object ) {
        ...
        if ( this.objectsMap[ object.uuid ] ) {
            ...
            this.objectsDataMap.delete(object);
    ...
    rebuildUpdated: function() {
        for(const object of this.objectsUpdated) {
            const objectData = this.objectsDataMap.get(object);
            if(!objectData) {
                continue;
            }

            objectData.update();
            if(!objectData.positionLast.equals(objectData.position) &&
                objectData.indexOctant !== objectData.node.getOctantIndex(objectData)) {
